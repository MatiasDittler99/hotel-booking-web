        ...
        <div className="edit-room-container">
            ...
            <div className="edit-room-form">
                <div className="form-group">
                    {preview ? (
                        <img src={preview} alt="Vista previa de la habitación" className="room-photo-preview" />
                    ) : (
                        roomDetails.roomPhotoUrl && (
                            <img src={roomDetails.roomPhotoUrl} alt="Habitación" className="room-photo" />
                        )
                    )}
                    <input
                        type="file"
                ...
                <button className="update-button" onClick={handleUpdate}>Actualizar habitación</button>
                <button className="delete-button" onClick={handleDelete}>Eliminar habitación</button>
            </div>
        </div>
    );
};
